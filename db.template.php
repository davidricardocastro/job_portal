...
//fill in database connetion information and change filename to db.php

class db 
{
    // database connection information
    protected static $host = ''; // fill in 
    protected static $username = ''; // fill in 
    protected static $password = ''; // fill in 
    protected static $database = ''; // fill in 
